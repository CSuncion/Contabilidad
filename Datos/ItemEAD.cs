...
namespace Datos
{
    ...
    public class ItemEAD
    {
        ...
        public List<ItemEEN> ListarItemsEXTabla(ItemEEN pObj)
        {
            SqlSelect xSel = new SqlSelect();
        ...
        public List<ItemEEN> ListarItemsEActivosXTabla(ItemEEN pObj)
        {
            SqlSelect xSel = new SqlSelect();
            xSel.SeleccionaVista(this.xVista);
            xSel.CondicionCV(SqlSelect.Reservada.Cuando, ItemEEN.CodEmp, SqlSelect.Operador.Igual, Universal.gCodigoEmpresa);
        ...
        public List<ItemEEN> ListarItemsEActivosXTablaYFiltroCodigo(ItemEEN pObj)
        {
            SqlSelect xSel = new SqlSelect();
            xSel.SeleccionaVista(this.xVista);
            xSel.CondicionCV(SqlSelect.Reservada.Cuando, ItemEEN.CodEmp, SqlSelect.Operador.Igual, Universal.gCodigoEmpresa);
